...
<h6 class="title flex align-center"><a href="<?php APP_URL; ?>Administracion/home">Inicio</a> / Categorias</h6>

<!-- -------------------- END OF TOTALS ------------>
<div class="recent-orders mb-5">
    <button class="añadir" type="button" title="Registrar" onclick="frmCategoria();"><span class="material-symbols-outlined">add</span></button>
    <div class="recent-orders tabla">
        <div class="d-grid gap-2 d-md-flex justify-content-md-between mb-4">
            ...
            <div>
                <button class="añadirpdf mt-2 btn-block text-right" title="Gestionar Reporte de Categorias">
                    <a class="fixText" onclick="btnPDFCategorias();">
        ...
        <table class="table stripe hover compact" id="tblCategorias">
...
<div id="nuevo_categoria" class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
